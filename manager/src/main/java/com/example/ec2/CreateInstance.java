...
public class CreateInstance {
    public static void create(Ec2Client ec2, InstanceType type, String key, String value, String amiId) {
        String USER_DATA_MANAGER =
                "#!/bin/bash\n" +
                        "sudo mkdir /home/ass/\n" +
                        "sudo aws s3 cp s3://dsps212jar/dsps212Worker.jar /home/ass/\n" +
                        "sudo /usr/bin/java -jar -Xmx1g /home/ass/dsps212Worker.jar\n" +
                        "shutdown -h now";

        String WORKER_ARN = "arn:aws:iam::104346479934:instance-profile/Worker";
        ...
        try {
            ...
            try {
                ...
                System.out.printf("didn't manage to create tag: %s\n", e.getMessage());
            }
